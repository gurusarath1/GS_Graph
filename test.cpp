...
int main()
{
    ...
    vector<vector<double>> edges_w_1 = {{1, 2, 1}, {2, 3, 1}, {1, 3, 10}};
    gs_directed_graph gw1(edges_w_1);
    cout << gw1.run_dijkstras_algorithm(1, 3);
    SEP(1001);

    vector<vector<double>> edges_w_2 = {{1, 2, 6}, {1, 5, 2}, {2, 3, 4}, {2, 11, 2}, {3, 4, 3}, {5, 3, 6}, {5, 6, 2}, {6, 3, 1}, {6, 7, 12}, {6, 12, 10}, {7, 9, 2}, {7, 8, 1}, {4, 10, 3}};
    gs_directed_graph gw2(edges_w_2);
    gw2.run_dijkstras_algorithm(1);
    SEP(1002);
